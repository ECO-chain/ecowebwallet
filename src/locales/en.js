export default {
  common: {
    ...
    notify: {
      ...
      parse: 'Parse',
      file: 'File',
      password_is_not_same_as_the_old_one: 'Password doesn\'t match.',
      mnemonics_are_not_same_as_the_words_should_remember: 'The mnemonic phrase is wrong!',
      mnemonics_can_not_restore: 'Bad combination of mnemonic words. Wallet can not be restored.',
      address_is_not_same_as_the_old_one: 'The address is different from the previous one.',
      from_address_is_not_same_as_the_wallet: 'The from address is different from the wallet address',
      restore_wif_fail: 'Cannot restore the wallet from this WIF',
      the_key_file_is_not_a_valid_format: 'The key file is not in a valid format',
      restore_key_file_fail: 'Restoration from key file failed. Maybe the password is wrong',
      connect_ledger_fail: 'Fail to connect to the ledger. Please re-plugin your ledger and try again',
      token_contract_address_is_not_exists: 'Token contract address doesn\'t exist, please check it and try again',
    },
    mode: {
      normal: 'Normal',
      offline: 'Offline',
  ...
  safe_send: {
    ...
    amount: 'Amount',
    fee: 'Fee',
    info: 'You need an online and offline PC and a removeable storage device to accomplish a safe-send. If you follow the tips below, you will not take the risk for your private key to get leaked. For the offline computer, please choose "offline" mode in settings  and then restore your wallet.',
    info1_online: 'Please complete the form, save the file and copy it to the offline computer. And the finish step 2 on the offline computer',
    info1_offline: 'Please finish step 1 on the online computer and copy the file from online computer and go to step 2',
    info2_online: 'Please finish this step on offline computer, and copy the file from offline computer and finally go to step 3',
    ...
    info3_offline: 'Please complete this step on the online computer',
  },
  send: {
  ...
  restore_ledger: {
    ...
    usage: 'Please ensure your firmware and app are the newest version. Plugin your Ledger, open ECOchain APP, and then click the "CONNECT" button below try to connect.',
    download: 'No ECOchain APP? Please install it follow this https://www.ledgerwallet.com/apps/manager',
    connect: 'CONNECT',
  },
  view: {
